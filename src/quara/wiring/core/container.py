...
class Container(typing.Generic[SettingsT]):
    ...
    routers: typing.List[
        typing.Union[
            fastapi.APIRouter,
            typing.Callable[
                [Container[BaseAppSettings]], typing.Optional[fastapi.APIRouter]
            ],
        ]
    ...
    providers: typing.List[
        typing.Callable[[Container[BaseAppSettings]], None],
    ] = dataclasses.field(default_factory=list)
    ...
    def __post_init__(self) -> None:
        ...
        for provider in self.providers:
            ...
            resources = provider(self)
            if resources is None:
                continue
            # Store resources so that they may be used later
            self.provided_resources[provider.__name__] = list(resources)
