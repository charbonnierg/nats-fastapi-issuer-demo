...
from .settings import BaseAppSettings, ConfigFilesSettings
...
class Container(typing.Generic[SettingsT]):
    ...
    routers: typing.List[
        typing.Union[
            fastapi.APIRouter,
            typing.Callable[[Container], typing.Optional[fastapi.APIRouter]],
        ]
    ...
    tasks: typing.List[
        typing.Union[
            ...
            AppTask[typing.Any],
            typing.Callable[[Container], typing.Optional[AppTask[typing.Any]]],
        ]
    ] = dataclasses.field(default_factory=list)
    # Providers
    providers: typing.List[
        typing.Callable[[Container], None],
    ] = dataclasses.field(default_factory=list)
    ...
    def __post_init__(self) -> None:
        ...
        if self.settings.oidc.enabled:
            if self.settings.oidc.client_id:
                if self.settings.meta.swagger_ui_init_oauth is not None:
                    self.settings.meta.swagger_ui_init_oauth["clientId"] = self.settings.oidc.client_id
                else:
                    self.settings.meta.swagger_ui_init_oauth = {"clientId": self.settings.oidc.client_id}
        self.app = fastapi.FastAPI(
            title=self.settings.meta.title,
            description=self.settings.meta.description,
            version=self.settings.meta.version,
            openapi_prefix=self.settings.meta.openapi_prefix,
            openapi_url=self.settings.meta.openapi_url,
            openapi_tags=self.settings.meta.openapi_tags,
            terms_of_service=self.settings.meta.terms_of_service,
            contact=self.settings.meta.contact,
            license_info=self.settings.meta.license_info,
            docs_url=self.settings.meta.docs_url,
            redoc_url=self.settings.meta.redoc_url,
            swagger_ui_oauth2_redirect_url=self.settings.meta.swagger_ui_oauth2_redirect_url,
            swagger_ui_init_oauth=self.settings.meta.swagger_ui_init_oauth,
        )
    ...
    @staticmethod
    def provider(request: fastapi.Request) -> Container:
...
class AppTask(typing.Generic[T]):
    ...
    def __init__(
        ...
        function: typing.Callable[
            [Container], typing.Coroutine[typing.Any, typing.Any, T]
        ],
        ...
        self._container: typing.Optional[Container] = None
    ...
    def bind(self, container: Container) -> AppTask[T]:
